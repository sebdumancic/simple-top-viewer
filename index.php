...
$families = array( 1 => array('himec01', 'himec02'),
                   ...
                   4 => array('pinac31', 'pinac32', 'pinac33', 'pinac34', 'pinac35', 'pinac36', 'pinac37', 'pinac38', 'pinac39', 'pinac40'),
                   5 => array('himec03', 'himec04'),
                 );
...
$families_notes = array( 0 => 'Various desktop PCs that are (seemingly) not used as such', // machines not in a family
                         ...
                         4 => '4-thread machines <abbr title="1-socket 4-core 4-thread">[1-4-4]</abbr>, 32 Gb memory',
                         5 => '32-thread machines <abbr title="2-socket 16-core 32-thread">[2-16-32]</abbr>, 128 Gb memory',
                       );
